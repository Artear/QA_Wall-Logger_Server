...
request("http://tn.codiarte.com/public/QA_Wall-Logger_Server-Helper/save_ip.php?localIp=" + ip.address() + "&socket_port=" + CONFIG.socket_port+ "&message_port=" + CONFIG.static_port, function (error, response, body) {
    _debug(body);
});
