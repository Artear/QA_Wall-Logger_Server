...
ANDROID_TOOLS_PATH="$ANDROID_SDK_FOLDER/android-sdk-macosx/tools"
...
echo ""
echo "** You need to have a JDK insalled for this to work!"
echo ""
echo ""
read -p "Only continue if you have the above installed! (Press any key to continue...)"
echo ""
echo ""
echo ""
...
unzip -o "$ANDROID_SDK_DOWNLOAD_DESTINATION" -d "$ANDROID_SDK_FOLDER"


$ANDROID_TOOLS_PATH/android update sdk --filter platform-tools
...
echo ""
echo "******************* ATTENTION! **************************"
echo "     Please add these to your .bash_profile "
echo "           export PATH=$ANDROID_TOOLS_PATH:\$PATH"
echo "           export PATH=$ANDROID_PLATFORM_TOOLS_PATH:\$PATH"
echo "*********************************************************"
echo ""
echo ""
echo ""
